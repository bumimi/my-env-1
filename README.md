...
git clone https://github.com/FrankFang/oh-my-env-1.git 将 oh-my-env-1 下载到本地（也可以直接下载 zip），重命名为 oh-my-env
...
删除之前的 oh-my-env 目录，下载最新的 oh-my-env，然后用 VSCode 打开，输入 Ctrl + Shift + P，然后输入 Reopen，回车，等待

如果你之前是用 git clone 下载的 oh-my-env-1，那么你也可以用 git pull 命令来更新代码
数据备份
# 首次备份
